...
class CWEMapper:
    ...
    def __init__(self):
        ...
        self.cwe_to_d3fend = {
            ...
            "CWE-352": ["D-MSI", "DMSA"],
            "CWE-400": ["D-MSI", "DMSA"],
            "CWE-295": ["D3-CBAN", "D3-CP", "D3-CA"],
            "CWE-296": ["D3-CBAN", "D3-TBA", "D3-AA"],
            "CWE-297": ["D3-CBAN", "D3-CA", "D3-ACA"],
            "CWE-326": ["D3-CBAN", "D3-MENCR", "D3-CP"],
            "CWE-523": ["D3-CBAN", "D3-CP", "D3-CERO"],
            "CWE-649": ["D3-CBAN", "D3-MFA", "D3-TB"],
        }
